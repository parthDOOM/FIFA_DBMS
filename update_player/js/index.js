...
var randomAngle = 0;
var currentArrow = null; // Reference to the currently created arrow
...
function loose() {
    ...
    // duplicate arrow
    currentArrow = document.createElementNS("http://www.w3.org/2000/svg", "use");
    currentArrow.setAttributeNS('http://www.w3.org/1999/xlink', 'href', "#arrow");
    arrows.appendChild(currentArrow);
